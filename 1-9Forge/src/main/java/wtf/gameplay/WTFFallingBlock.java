...
public class WTFFallingBlock extends EntityFallingBlock{
	    ...
	    public WTFFallingBlock(World worldIn)
	    {
	        super(worldIn);
	    }

	    public WTFFallingBlock(World worldIn, double x, double y, double z, IBlockState fallingBlockState)
	    {
	        super(worldIn);
	                    ...
	                    if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION)
	                    {
	                        ...
	                        if (!this.canSetAsBlock)
	                        {
	                            		...
	                            		&& this.worldObj.setBlockState(blockpos1, this.fallTile, 3))
	                            {
	                                ...
	                                GravityMethods.checkPos(this.worldObj, blockpos1.down());
