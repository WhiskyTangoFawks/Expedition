...
public class RedstoneStalactite extends BlockSpeleothem{
	...
	public RedstoneStalactite(boolean isOn) {
	 ...
	 public int tickRate(World worldIn)
	    ...
	    Block[] ores = {Blocks.REDSTONE_ORE, Blocks.LIT_REDSTONE_ORE, DenseRedstoneOre.denseRedstone_off, DenseRedstoneOre.denseRedstone_on};
	    HashSet<Block> redstone = new HashSet<Block>(Arrays.asList(ores));
	    
	    private IBlockState getToggled(IBlockState state){
	    	//int density = state.getValue(DENSITY);
	    	return state.getBlock().hashCode() == this.denseRedstone_off.hashCode() ? denseRedstone_off.getDefaultState():	denseRedstone_on.getDefaultState();
