...
import wtf.core.blocks.BlockIcicle.IcicleType;
import wtf.core.blocks.BlockRoots;
import wtf.core.blocks.BlockRoots.RootType;
import wtf.core.blocks.BlockSpeleothem.SpType;
...
public class CaveBiomeGenMethods{
	...
	public final HashMap<BlockPos, IBlockState> blocksToSet;
	public final Random random;

	public CaveBiomeGenMethods(Chunk chunk, Random random) {
		this.chunk = chunk;
		blocksToSet = new HashMap<BlockPos, IBlockState>();
		this.random = random;
	}
